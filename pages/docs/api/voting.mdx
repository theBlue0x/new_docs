...
**Example:** Refer to [Cast Vote](examples.mdx#cast-vote) example.
...
**Example:** Refer to [Create Poll](examples.mdx#create-poll) example.
...
**Example:** Refer to [Get Poll](examples.mdx#get-poll) example.
...
**Example:** Refer to [Get Poll Result](examples.mdx#get-poll-result) example.
...
**Example:** Refer to [Get Poll Vote](examples.mdx#get-poll-vote) example.
...
**Example:** Refer to [Get Poll Votes](examples.mdx#get-poll-votes) example.
...
**Example:** Refer to [Get Polls](examples.mdx#get-polls) example.
...
**Example:** Refer to [Search Polls](examples.mdx#search-polls) example.
