...
**Example:** Refer to [Event Register](examples.mdx#event-register) example.
...
**Example:** Refer to [Event Wait](examples.mdx#event-wait) example.
...
**Example:** Refer to [Get Blockchain Status](examples.mdx#get-blockchain-status) example.
...
**Example:** Refer to [Get Plugins](examples.mdx#get-plugins) example.
...
**Example:** Refer to [Get State](examples.mdx#get-state) example.
...
**Example:** Refer to [Get Time](examples.mdx#get-time) example.
