...
**Example:** Refer to [Decode QR Code](examples.mdx#decode-qr-code) example.
...
**Example:** Refer to [Detect Mime Type](examples.mdx#detect-mime-type) example.
...
**Example:** Refer to [Encode QR Code](examples.mdx#encode-qr-code) example.
...
**Example:** Refer to [Full Hash To Id](examples.mdx#full-hash-to-id) example.
...
**Example:** Refer to [Hash](examples.mdx#hash) example.
...
**Example:** Refer to [Hex Convert](examples.mdx#hex-convert) example.
...
**Example:** Refer to [Long Convert](examples.mdx#long-convert) example.
...
**Example:** Refer to [RS Convert](examples.mdx#rs-convert) example.
